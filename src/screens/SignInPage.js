...
import { handleSignIn } from '../logic/AuthStore';
import styles from './SignInPageStyles';


function StoreSignIn({ navigation }) {
        ...
        <ScrollView>
            <SafeAreaView style={{ flex: 1 }}>
                <View style={styles.container}>
                    ...
                    <Image source={require('../assets/icon1.png')} style={styles.logoImage} />
